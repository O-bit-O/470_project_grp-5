...
export default function Signup() {
    ...
    return (
        <div style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1628771065518-0d82f1938462?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fG1lZGljaW5lfGVufDB8fDB8fHww&w=1000&q=80")', backgroundSize: 'cover', height: '100vh' }}>
            <div>
                <Navbar />
            </div>
